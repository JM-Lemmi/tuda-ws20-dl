...
#will contain multiples for Text or Chapter, if a text contains multiple chapters or a chapter contains mulitple comments. This is to make later aggregation easier
...
#write.csv(anon.dataframe, file="anon_dataframe.csv")
